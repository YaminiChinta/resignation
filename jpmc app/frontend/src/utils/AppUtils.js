...
export function apiGetAllStories() {
  return request({
    url: API_URL + "/story/getAllStories",
    method: "GET",
  });
}
...
export function apiGetAllSprints() {
  return request({
    url: API_URL + "/sprint/getAllSprints",
    method: "GET",
  });
}
...
export function apiGetGenCDashboardMetrics(associateId) {
  return request({
    url: API_URL + "/gencTracker/dashboard",
    method: "GET",
  });
}
...
export function apiGetEpicStories(epicId) {
  return request({
    url: API_URL + "/epic/" + epicId + "/stories",
    method: "GET",
  });
}
