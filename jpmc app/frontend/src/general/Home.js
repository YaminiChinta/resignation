        ...
        >
          ...
          <div>
            ...
            >
              ...
              <div class="chart">
                <ul class="numbers">
                  <li>
                    <span style={{ borderTop: "1.5px solid  #e4e5f7" }}>
                      60
                    </span>
                  </li>
                  <li>
                        ...
                        height: `${
                          ...
                          drivesData
                            .filter((drive) => {
                              return (
                                new Date(
                                  drive.interviewDriveDate
                                ).getFullYear() == new Date().getFullYear()
                              );
                            })
                            .filter((drive) => {
                              return (
                                new Date(drive.interviewDriveDate).getMonth() ==
                                0
                              );
                            }).length * 4.7
                        }px`,
          ...
          <div>
            ...
            >
              ...
              <table>
                <thead>
                  <tr style={{ borderTop: "2px solid  #e4e5f7" }}>
                ...
                <tbody>
                  {skillViews &&
                    skillViews.map((skill) => {
                      return (
                        <tr>
                          <td style={{ borderBottom: "1.5px solid  #e4e5f7" }}>
                            {skill.label}
                          </td>

                          <td
                            style={{
                              borderBottom: "1.5px solid #e4e5f7",
                              textAlign: "center",
                            }}
                          >
                            {trainingData &&
