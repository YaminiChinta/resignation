    ...
    <div>
      <div>
        <div>
          ...
          <table>
            <h5 className={classes.formheading}>
          ...
          <table>
            <h5 className={classes.formheading}>Working/Leave Table</h5>
          </table>
              ...
              {trainingData &&
                trainingData.map(
                  ({ training, avgProgress, progress, isNominated }, i) => {
                    const isClosed =
                      new Date(training.endDate) - Date.now() < 0;
                    return (
          ...
          <table>
            {" "}
            <h5 className={classes.formheading}>
              Month Wise Trainings Completed
            </h5>
          </table>
          <table className="internal">
            <thead>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 1
                        );
                      }).length}
                </td>
                ...
                <td className="profiletable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 2
                        );
                      }).length}
                </td>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 3
                        );
                      }).length}
                </td>
                ...
                <td className="profiletable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 4
                        );
                      }).length}
                </td>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 5
                        );
                      }).length}
                </td>
                ...
                <td className="profiletable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 6
                        );
                      }).length}
                </td>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 7
                        );
                      }).length}
                </td>
                ...
                <td className="profiletable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 8
                        );
                      }).length}
                </td>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 9
                        );
                      }).length}
                </td>
                ...
                <td className="profiletable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 10
                        );
                      }).length}
                </td>
                ...
                <td className="profilecontenettable">
                  {trainingData &&
                    trainingData
                      ...
                      .filter((training) => {
                        return (
                          new Date(training.training.endDate).getMonth() == 11
                        );
                      }).length}
                </td>
              </tr>
          ...
          <table>
            {" "}
            <h5 className={classes.formheading}>Interview </h5>
          </table>
          <table className="internal">
            <tr>
              <th>Skills </th>
          ...
          <table>
            {" "}
            <h5 className={classes.formheading}>Referal</h5>
          </table>

          <table>
            {" "}
            <h5 className={classes.formheading}>Resignations</h5>
          </table>
        </div>
      </div>
    </div>
