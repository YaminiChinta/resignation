          ...
          {sprint &&
            sprint.storyIds.map((id) => {
              return stories
                ...
                .map((index) => {
                  return (
                    <tr key={index.id} className={`${classes.tablerow}`}>
                      <td className="tdcentercontent">
                        <Link
                          className={classes.link}
                          to={`/ui/gencTracker/stories/${index.id}/storyDetails`}
                        >
                          {index.subject}
                      ...
                      <td className="tdcentercontent">
                        {index.owner.associateName}
                      </td>
                      <td className="tdcentercontent">
                        {" "}
                        {index.storyPriority.groupValue}
                      </td>
                      <td className="tdcentercontent">{index.epic.name}</td>
                      <td className="tdcentercontent">
                        {index.storyStatus.groupValue}
                      </td>
                    </tr>
                  );
                });
